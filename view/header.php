                ...
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.php"><img
                                    class="main__logo--img" width="150px" src="./view/assets/img/logo/logo.png"
                                    alt="logo-img"></a></h1>
                    </div>
                        ...
                        <form class="d-flex header__search--form" action="index.php?pg=shop" method="post">
                            ...
                            <div class="header__search--box">
                                ...
                                <button class="header__search--button bg__secondary text-white" type="submit"
                                    name="search" aria-label="search button">
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn minicart__open--btn" href="javascript:void(0)"
                                    ...
                                    <span class="items__count"
                                        id="cart-item-count"><?php echo count($_SESSION['giohang']); ?></span>
                                </a>
                            </li>
                        </ul>
                    </div>
