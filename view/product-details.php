                    ...
                    <div class="breadcrumb__content text-center">
                        ...
                        <ul class="breadcrumb__content--menu d-flex justify-content-center">
                            <li class="breadcrumb__content--menu__items"><a class="text-white" href="index.php">Trang
                                    chủ</a></li>
                            <li class="breadcrumb__content--menu__items"><span class="text-white">Chi tiết sản
                                    phẩm</span></li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox"
                                            data-gallery="product-media-preview" href="./uploads/<?= $img ?>"><img
                                                class="product__media--preview__items--img" src="./uploads/<?= $img ?>"
                                                alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox"
                                                href="./uploads/<?= $img ?>" data-gallery="product-media-preview">
                ...
                <div class="col">
                    <div class="product__details--info">
                        ...
                        <form action="index.php?pg=addcart" method="post" class="product__variant">
                            <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                ...
                                <div class="quantity__box">
                                    ...
                                    <label>
                                        <input type="number"
                                            class="quantity__number quickview__value--number form-input-number"
                                            name="amount" min="1" max="50" value="1" data-counter />
                                    </label>
                                    <button type="button" class="quantity__value quickview__value--quantity increase"
                                        aria-label="quantity value" value="Increase Value">+</button>
                                </div>
                                <button class="quickview__cart--btn primary__btn" type="submit" name="btnaddcart">Thêm
                                    vào giỏ hàng</button>
                            </div>
                            <div class="product__variant--list mb-15">
                                <button class="variant__buy--now__btn primary__btn" type="submit" name="btnaddcart">Mua
                                    ngay</button>
                            </div>
                        ...
                        <div class="guarantee__safe--checkout">
                            ...
                            <img class="guarantee__safe--checkout__img" src="./view/assets/img/other/safe-checkout.png"
                                alt="Payment Image">
                        </div>
                    </div>
                </div>
                                        ...
                                        <form action="index.php?pg=process-comment" method="post" id="commentForm">
                                            ...
                                            <div class="row" id="">
                                                <div class="col-12 mb-10">
                                                    <textarea name="content" class="reviews__comment--reply__textarea"
