...
<main class="main__content_wrapper">
    ...
    <section class="hero__slider--section">
        <div
            class="hero__slider--inner hero__slider--activation swiper swiper-initialized swiper-horizontal swiper-pointer-events">
            <div class="hero__slider--wrapper swiper-wrapper" id="swiper-wrapper-06a210710257921cb3" aria-live="off"
                style="transform: translate3d(-2013px, 0px, 0px); transition-duration: 800ms;">
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active"
                    data-swiper-slide-index="2" style="width: 641px; margin-right: 30px;" role="group"
                    aria-label="3 / 3">
                                    ...
                                    <div class="hero__slider--items__inner">
                                        <div class="slider__content text-center">
                                            <p class="slider__content--desc desc1 mb-15"><img
                                                    ...
                                                    src="assets/img/icon/text-shape-icon.png" alt="text-shape-icon"> New
                                                Collection</p>
                ...
                <div class="swiper-slide swiper-slide-duplicate-next" data-swiper-slide-index="0"
                    style="width: 641px; margin-right: 30px;" role="group" aria-label="1 / 3">
                ...
                <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="1"
                    style="width: 641px; margin-right: 30px;" role="group" aria-label="2 / 3">
                ...
                <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="2"
                    style="width: 641px; margin-right: 30px;" role="group" aria-label="3 / 3">
                    <div class="hero__slider--items home1__slider--bg three">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-6 offset-lg-6">
            ...
            <div class="swiper__nav--btn swiper-button-next" tabindex="0" role="button" aria-label="Next slide"
                aria-controls="swiper-wrapper-06a210710257921cb3"></div>
    ...
    <section class="product__section section--padding pt-0">
        <div class="container-fluid">
            ...
            <ul class="product__tab--one product__tab--primary__btn d-flex justify-content-center mb-50">
                <li class="product__tab--primary__btn__list active" data-toggle="tab" data-target="#featured">Đặc sắc
                </li>
                <li class="product__tab--primary__btn__list" data-toggle="tab" data-target="#trending">Xu hướng</li>
                <li class="product__tab--primary__btn__list" data-toggle="tab" data-target="#newarrival">Hàng mới về
                </li>
            </ul>
