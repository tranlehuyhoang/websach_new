                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" placeholder="Type here" class="form-control"
                                id="product_name" value="<?= ($name != "") ? $name : ""; ?>">
                        </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row gx-2">
                                        <input placeholder="VND" type="number" name="old_price"
                                            class="form-control form-input-number" value="1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="checkbox" name="bestseller" <?= $bestcheck ?> class="form-control1"
                                id="product_bestseller">
