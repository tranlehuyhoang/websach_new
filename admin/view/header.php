            ...
            <div class="col-search">
                <form class="searchform">
                    <div class="input-group">
                        ...
                        <button class="btn btn-light bg btn-fix" type="button"> <i
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownLanguage">
                            <a class="dropdown-item text-brand" href="#"><img src="./view/assets/imgs/theme/flag-us.png"
                                    alt="English">English</a>
                            <a class="dropdown-item" href="#"><img src="./view/assets/imgs/theme/flag-fr.png"
                    ...
                    <li class="dropdown nav-item">
                        <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#" id="dropdownAccount"
                            aria-expanded="false"> <img class="img-xs rounded-circle"
                                src="./view/assets/imgs/people/quantri.jpg" alt="User"></a>
